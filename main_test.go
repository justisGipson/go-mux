...
func executeRequest(req *http.Request) *http.ResponseWriter {
...
func TestCreateProduct(t *testing.T) {
	...
	// id is compared to 1.0 because JSON unmarshaling converts numbers to floats
...
func addProducts(count int) {
	...
	for i := 0; i < count; i++ {
		a.DB.Exec("INSERT INTO products(name, price) VALUES($1, $1", "Product "+srtconv.Itoa(i), (i+1.0)*10)
	}
}
